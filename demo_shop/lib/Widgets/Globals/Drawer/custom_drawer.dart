  ...
  String _labelFor(DrawerItem item) {
    switch (item) {
      case DrawerItem.home:
        return getIt<LocalizationService>().localizations.drawer_item_home;

      case DrawerItem.profile:
        return getIt<LocalizationService>().localizations.drawer_item_profile;

      case DrawerItem.search:
        return getIt<LocalizationService>().localizations.drawer_item_search;

      case DrawerItem.category:
        return getIt<LocalizationService>().localizations.drawer_item_cat;

      case DrawerItem.cart:
        return getIt<LocalizationService>().localizations.drawer_item_cart;

      case DrawerItem.logout:
        return getIt<LocalizationService>().localizations.drawer_item_logout;
    }
  }
