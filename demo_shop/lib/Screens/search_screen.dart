      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              getIt<LocalizationService>().localizations.search_screen_header,
          ...
          if (_search.isEmpty)
            Padding(
              ...
              child: Center(
                child: Text(
                  getIt<LocalizationService>().localizations.search_screen_text,
                  style: GoogleFonts.montserrat(
                    color: AppColors.textSecondary,
            ...
            productsAsync!.when(
              ...
              error: (error, stack) => Padding(
                ...
                child: Text(
                  '${getIt<LocalizationService>().localizations.search_screen_error}\n$error',
