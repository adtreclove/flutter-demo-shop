...
import 'package:demo_shop/Widgets/Products/order_overlay.dart';
            ...
            child: SizedBox(
              ...
              child: AnimatedBorderButton(
                onPressed: () async {
                  ...
                  await showOrderSuccessOverlay(
                    context,
                    message: getIt<LocalizationService>()
                        .localizations
                        .added_to_cart_text,
                  );
                ...
                child: Text(
                  getIt<LocalizationService>().localizations.buy_now_text,
                  style: GoogleFonts.montserrat(
