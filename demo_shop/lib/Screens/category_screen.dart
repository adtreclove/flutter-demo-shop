...
import 'package:demo_shop/Widgets/Category/animated_category_list.dart';
        ...
        children: [
          ...
          productsAsync.when(
            ...
            error: (e, _) => Padding(
              ...
              child: Text(
                getIt<LocalizationService>().localizations.error + e.toString(),
              ),
            ),
    ...
    child: Row(
      children: [
        TextButton(
          ...
          child: Text(
            getIt<LocalizationService>().localizations.cat_screen_men,
        ...
        TextButton(
          ...
          child: Text(
            getIt<LocalizationService>().localizations.cat_screen_women,
            style: GoogleFonts.montserrat(
              fontSize: 25,
